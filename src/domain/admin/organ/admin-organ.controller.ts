...
import { ReadOrganPostDto } from '@/domain/common/organ-post/dto/read-organ-post.dto';
...
import { ReadTrainingUnitDto } from '@/domain/common/organ/dto/read-training-unit.dto';
...
@Controller('admin/organ')
export class AdminOrganController {
    ...
    async getTrainingUnitByOperationalType(
        ...
        return this.service.getTrainingUnitByOperationalType(
            operationalIdList,
            checkUserOrganScope,
        );
    }
    ...
    async deleteOperationalsByOrganId(
        @Param('id') id: number,
    ): Promise<OrganOperational> {
    ...
    async getAllByOrganId(
        @Param('id') id: number,
    ): Promise<ReadOrganOperationalDto> {
        return this.service.getAllOperationalByOrganId(id);
    }

    @Post(':id/organ-operational')
    createOperationalOrgan(
        @Body() data: CreateOrganOperationalDto,
    ): Promise<ReadOrganOperationalDto> {
    ...
    async getAllPostByOrganId(
        @Param('id') id: number,
    ): Promise<ReadOrganPostDto> {
