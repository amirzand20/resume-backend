...
import {CreateBaseInfoItemDto} from "@/domain/common/base-info-item/dto/create-base-info-item.dto";
import { OAuthJwtGuard } from '@/auth/guards/oauth-jwt-guard.guard';

@Controller('admin/base-info-item')
@ApiTags('admin-base-info-item')
@UseGuards(OAuthJwtGuard)
@ApiBearerAuth('sso-auth')
@UseInterceptors(HttpCacheInterceptor)
export class AdminBaseInfoItemController {
